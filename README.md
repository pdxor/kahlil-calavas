...
The “View Kahlil’s timeline” callout opens a native modal dialog. `app/timeline-moments.ts` holds 14 selected moments from 2023–2026, their source links, image descriptions, credits, and themes. The story follows Joe LaRose’s 3D printed buckyball, MIT Reality Hack, the incubator and accelerator, AWE, a UN STI Forum side event, EcoTerra visualization, modular architectural systems, EcoDome, a fundraising digital twin, the Boxboi official pilot, and Future Lab. Dates mark source publication unless an archive, catalog, or event date is explicitly labeled. The garden entry uses the fundraiser publication date, not a claimed twin creation date.
